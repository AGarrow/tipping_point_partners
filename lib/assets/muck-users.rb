MuckEngine.configure do |config|
  ...
  config.application_name = 'Tipping_Point_Partners'       # Common name for your application.  i.e. My App, Billy Bob, etc
  config.from_email = 'support@tippingpointpartners.com'     # Emails will come from this address i.e. noreply@example.com, support@example.com, system@example.com, etc
  config.from_email_name = 'support@tippingpointpartners.com'        # This will show up as the name on emails.  i.e. support@example.com <Example>
  config.support_email = 'support@tippingpointpartners.com'  # Support email for your application.  This is used for contact us etc.
  config.admin_email = 'admin@tippingpointpartners.com'      # Admin email for your application
